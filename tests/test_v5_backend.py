...
async def test_lifespan_starts_and_stops_background_loops(admin):
    async with main._lifespan(main.app):
        assert [t.get_name() for t in main._loop_tasks] == ["health-loop", "discord-health-loop", "history-prune-loop", "journal-import-loop", "pnl-loop", "copy-loop", "news-loop", "heartbeat-loop"]
        await settle()
