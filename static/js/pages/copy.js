...
function groupDrawer(group, { reload, onClose = null }) {
  ...
  openDrawer({
    ...
    body: [
      ...
      h("div", { class: "grid grid-2" },
        h("div", { class: "field" }, h("label", null, "After feed loss of (seconds)"), h("div", { style: "display:flex;gap:8px;flex-wrap:wrap" }, lossInp, lossSel), h("div", { class: "field-hint" }, "No leader feed (broker unreachable, token or login dead, agent offline) for this long → the chosen action. Flatten closes every mirrored follower position at market.")),
